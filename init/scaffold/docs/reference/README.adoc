...
Information-oriented documentation. Reference describes the
system neutrally, exhaustively, and accurately. Readers come
here knowing what they want to look up.
